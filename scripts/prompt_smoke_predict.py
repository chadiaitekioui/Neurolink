...
def _iterative_v2(
    ...
    *,
    ...
    audit = {
        ...
        "context_source": "build_generation_prompt (Year N → Year N+1, shared train/predict)",
        "requested_k": k,
        "returned": len(kept),
...
def run_smoke(cfg: PromptSmokeConfig) -> Path:
    ...
    results: dict = {
        ...
        "config": {
            ...
            "models": cfg.models,
            "prompt": "year_n_to_n_plus_1",
            "setup": "Year N (30 DB articles, no per-line years) → Year N+1; shared train/predict",
            "semantic_threshold": cfg.semantic_threshold,
